...
class DecoyPinScreen extends ConsumerStatefulWidget {
  const DecoyPinScreen({super.key});

  @override
  ConsumerState<DecoyPinScreen> createState() => _DecoyPinScreenState();
}

class _DecoyPinScreenState extends ConsumerState<DecoyPinScreen> {
  String _pin = '';
  String _confirmPin = '';
  ...
  void _validatePin() async {
    if (_pin == _confirmPin) {
      ...
      await ref.read(onboardingProvider.notifier).setDecoyPin(_pin);
      _completeOnboarding();
    } else {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    _isConfirming ? 'Confirm Decoy PIN' : 'Set a Decoy PIN',
                  ...
                  Text(
                    _isConfirming
                        ...
                        : 'Add a fake vault to show if pressured',
